...
<body>
	<header>
		<a href="http://fenghuang2015.com/newyear/ " target="_blank" class="ad"><img src="images/960x90.gif" alt="" /></a>
		<div class="layout">
	...
	<article class="content clearfix">
		<div class="layout">
			<div class="activity-desc">
				<h3><strong>活动时间</strong>2015年3月2日00:00:00-3月31日23:59:59</h2>
				<h3><strong>活动说明</strong>在活动期间凤凰新注册用户并完成指定任务的新用户最高可获赠百元彩金：</h3>
				<ul class="line">
					<li>新用户注册并绑定银行卡后在线充值10元或以上即可获赠 <span style="color:#FCDDA7;">24</span>元（已在平台绑定过的银行卡将不算入其内，新绑定姓名相同的银行卡只考核其一）；</li>
					<li>完成注册充值的新用户在活动期间（3.2-4.4）游戏满688元并有一次成功提款后即可再次获赠<span style="color:#F6B1BA;">76元</span>；</li>
					<li>所有阶段彩金将在用户符合赠送标准后的第二工作日内发放到用户账户中，奖金发放不另行通知，请用户留意查看自己的帐变记录，如有疑问请咨询<span style="color:#B3A2F9;cursor:pointer;" class="service">在线客服</span>。</li>
				</ul>
				<dl class="rule">
					<dt>活动规则：</dt>
					<dd>1.用户必须绑定真实的银行卡，否则会影响后续的彩金提现；</dd>
					<dd>2.本活动仅限新注册用户，与其它活动不冲突；</dd>
					<dd>3.一个用户注册多个账号参与活动视为作弊，使用“全包“投注视为作弊，网站有权取消奖励；</dd>
				</dl>
			</div>
		</div>
	</article>
	<div class="float-box">
		<a target="_blank" href="http://www.fh885.com">立即登录</a>
		<a target="_blank" href="http://www.fenghuang158.com/yhsc">查看凤凰用户手册</a>
		<a target="_blank" href="http://fenghuang2015.com/newyear/ ">最高28888羊年红包</a>
	</div>
	<footer>
		<div class="layout">
