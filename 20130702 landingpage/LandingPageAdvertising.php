...
<body class="advertising">
	...
	<div class="banner banner10" >
		<div class="banner-inner">
			<div class="advisory">
				<?php
				$num = rand(0, count($hao360) - 1);
				echo '<a target="_blank" href="'.$hao360[$num].'" style="display:block;width:86%;height:85px;margin:0px auto"></a>';
	...
	<div class="content">
		<div class="content-inner">
			<div class="advisory-box">
				...
				<div class="clearfix">
					...
					<div class="qq">
						...
						<dl class="bd">
							<?php
							$num = rand(0, count($hao360) - 1);
							echo '<dt><a style="display: block;height: 55px;width: 166px;" href="'.$hao360[$num].'"></a></dt>';
							?>
							<?php
				...
				<div class="ad-list">
					<a href="http://www.591ph.com/m" target="_blank" title="凤凰APP"><img src="images/ad1.jpg" alt="" /></a>
					<a href="http://lollylotto.blog.163.com" target="_blank" title="乐利彩"><img src="images/ad2.jpg" alt="" /></a>
					<a title="双色球"><img src="images/ad3.jpg" alt="" /></a>
				</div>
				<div class="seo-list">
...
<script>
  ...
  ga('create', 'UA-43555041-1', 'fenghuangzhuanqu.com');
  ga('send', 'pageview');
