...
<head>
	...
	<link rel="stylesheet" href="http://static.rfonlineedu.com:888/static/images/proxy/proxy.css" />
    ...
    <script type="text/javascript">hjUserData= "admin|0||13800000|test@test.com|哥伦比亚|||22222|31|0|";global_userName="admin";</script>
	...
	<script type="text/javascript" src="http://static.rfonlineedu.com:888/static/js/phoenix.Message.js"></script>
	...
	<script type="text/javascript" src="http://static.rfonlineedu.com:888/static/js/phoenix.GlobalAd.js"></script>
    <!--<script type="text/javascript" src="http://static.rfonlineedu.com:888/static/js/phoenix.Notice.js"></script>
    <script id="HJLiveChatPageScript" src="http://www.26hn.com:7006/web/code/code.jsp?c=1&s=21"></script>-->


    
	
		<script>
	function CheckingMaxAllFull(obj,maxValue,minValue){
	...
	if(me.value < miniValue){ me.value=minValue}
...
<!-- //////////////头部公共页面////////////// -->
	...
	<div class="toolbar">
		<div class="g_33">
				...
				<span class="game-menu-text">凤凰游戏</span>
				<div class="game-menu-panel">
					<div class="game-menu-inner clearfix">
						<div class="game-menu-left">
							<div class="game-menu-title">高频(13)</div>
							<ul>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/cqssc/">重庆时时彩</a><span class="ico-game-new"></span><!-- <span class="ico-addbonus"></span> --></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/sd115/">山东11选5</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/jxssc/">江西时时彩</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/jx115/">江西11选5</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/hljssc/">黑龙江时时彩</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/gd115/">广东11选5</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/xjssc/">新疆时时彩</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/cq115/">重庆11选5</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/tjssc/">天津时时彩</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/ll115/">乐利11选5</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/llssc/">乐利时时彩</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/bjkl8/">北京快乐8</a></li>
								<li class="border-none"><a target="_blank" href="http://em.joy188.com:888/gameBet/shssl/">上海时时乐</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/slmmc">顺利秒秒彩</a></li>
							</ul>
						</div>
						<div class="game-menu-right">
							<div class="game-menu-title">低频(4)</div>
							<ul>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/ssq/">双色球</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/fc3d/">福彩3D</a></li>
								<li><a target="_blank" href="http://em.joy188.com:888/gameBet/p5/">排列3/5</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<ul class="menu">
					<li class="user hover" id="J-user-panel">
						<a href="#">您好，admin<i class="tri" id="J-user-tri"></i></a>
						<div class="menu-nav">
							<i class="tri"></i>
							<a href="http://em.joy188.com:888/gameUserCenter/queryOrders?userId=31&time=7">游戏记录</a>
							<a href="http://em.joy188.com:888/gameUserCenter/queryCurrentUserReport?userId=31">报表管理</a>
					...
					<li class="balance"><span id="hiddBall" style="display:none">余额：<span id="spanBall">41,688,591.74</span></span><span id="hiddenBall">余额已隐藏 <a href="#" id="showAllBall">显示</a></span></li>
					<li class="withdrawals"><a href="/fund">充值</a></li>
					<li class="withdrawals"><a href="/withdraw">提现</a></li>
					<!--<li class="withdrawals"><a target="_blank" href="http://em.joy188.com:888/gameBet/bet?lotteryId=99101">游戏入口</a></li>-->
	...
	<div class="header">
		<div class="g_33">
			...
			<div class="service">
				<a title="客服" class="link-service" href="javascript:hj5107.openChat()" />在线客服</a>
				<a title="帮助" class="link-help" href="http://www2.joy188.com:888/help/goIndex">帮助</a>
			</div>
		</div>
	</div>
	<!-- header end -->
...
<!-- /////////////头部公共页面/////////////// -->	
	...
	<!-- //////////////左侧公共页面////////////// -->
				...
				<div class="nav-side">
					<dl class="side-bet">
						...
						<dd><a href="http://em.joy188.com:888/gameUserCenter/queryOrders?userId=31&time=7">投注记录</a></dd>
						<dd><a href="http://em.joy188.com:888/gameUserCenter/queryPlans?time=7">追号记录</a></dd>
					...
					<dl class="side-safe">
						...
						<!--  -->
						<dd><a href="http://em.joy188.com:888/gameUserCenter/queryBonusDetails?type=0&awardType=0">奖金详情</a></dd>
						<!--  -->
					</dl>
					...
					<dl class="side-proxy">
						...
						<dd><a href="http://em.joy188.com:888/gameUserCenter/queryCurrentUserReport?userId=31">报表查询</a></dd>
					</dl>
					<!--  -->
					<dl class="side-funds">
					...
					<div class="rebate-list">
									...
									<dd>
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">直选返点</a>
													<input type="input" class="input w-2" name="directRet_1_130"  value="0-4.9" maxvalue="4.9" onKeyUp="CheckingMaxAllFull(this,'4.9')" onBlur="CheckingMaxAllFull(this,'4.9')"/>
													<span>(可分配返点范围为0-4.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_1_130" value="0-1"/></td>
											</tr>
											<tr>
												<td>
													<a class="label-like" data-wanfa="blah">不定位返点</a>
													<input type="input" onKeyUp="CheckingMaxAllFull(this,'4.9')" onBlur="CheckingMaxAllFull(this,'4.9')" class="input w-2" maxvalue="4.9" value="0-4.9" name="threeoneRet_1_130"/>
													<span>(可分配返点范围为0-4.9)</span>
												</td>
											</tr>
										</table>
									...
									<dd class="bet-selected">
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">直选返点</a>
													<input type="input" class="input w-2" name="directRet_1_131"  value="0-9.9" maxvalue="9.9" onKeyUp="CheckingMaxAllFull(this,'9.9')" onBlur="CheckingMaxAllFull(this,'9.9')"/>
													<span>(可分配返点范围为0-9.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_1_131" value="0-1"/></td>
											</tr>
											<tr>
												<td>
													<a class="label-like" data-wanfa="blah">不定位返点</a>
													<input type="input" onKeyUp="CheckingMaxAllFull(this,'4.9')" onBlur="CheckingMaxAllFull(this,'4.9')" class="input w-2" maxvalue="4.9" value="0-4.9" name="threeoneRet_1_131"/>
													<span>(可分配返点范围为0-4.9)</span>
												</td>
											</tr>
										</table>
									...
									<dd>
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">直选返点</a>
													<input type="input" class="input w-2" name="directRet_1_178"  value="0-19.9" maxvalue="19.9" onKeyUp="CheckingMaxAllFull(this,'19.9')" onBlur="CheckingMaxAllFull(this,'19.9')"/>
													<span>(可分配返点范围为0-19.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_1_178" value="0-1"/></td>
											</tr>
											<tr>
												<td>
													<a class="label-like" data-wanfa="blah">不定位返点</a>
													<input type="input" onKeyUp="CheckingMaxAllFull(this,'12.9')" onBlur="CheckingMaxAllFull(this,'12.9')" class="input w-2" maxvalue="12.9" value="0-12.9" name="threeoneRet_1_178"/>
													<span>(可分配返点范围为0-12.9)</span>
												</td>
											</tr>
										</table>
									</dd>
									...
									<dd class="bet-selected">
										<table class="table">
											<tr>
												<td>奖金组1782：</td>
												<td>
													<a class="label-like" data-wanfa="blah">所有玩法返点</a>
													<input type="input" class="input w-2" name="directRet_3_145"  value="0-4.9" maxvalue="4.9" onKeyUp="CheckingMaxAllFull(this,'4.9')" onBlur="CheckingMaxAllFull(this,'4.9')"/>
													<span>(可分配返点范围为0-4.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_3_145" value="0-1"/></td>
											</tr>
										</table>
									</dd>
									<dd>
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">所有玩法返点</a>
													<input type="input" class="input w-2" name="directRet_3_144"  value="0-12.9" maxvalue="12.9" onKeyUp="CheckingMaxAllFull(this,'12.9')" onBlur="CheckingMaxAllFull(this,'12.9')"/>
													<span></span>
													<span>(可分配返点范围为0-12.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_3_144" value="0-1"/></td>
											</tr>
										</table>
									</dd>
								</dl>
									...
									<dd class="bet-selected">
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">任选型返点</a>
													<input type="input" class="input w-2" name="directRet_4_152"  value="0-14.9" maxvalue="14.9" onKeyUp="CheckingMaxAllFull(this,'14.9')" onBlur="CheckingMaxAllFull(this,'14.9')"/>
													<span>(可分配返点范围为0-14.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_4_152" value="0-1"/></td>
											</tr>
											<tr>
												<td>
													<a class="label-like" data-wanfa="blah">趣味型返点</a>
													<input type="input" onKeyUp="CheckingMaxAllFull(this,'9.9')" onBlur="CheckingMaxAllFull(this,'9.9')" class="input w-2" maxvalue="9.9" value="0-9.9" name="threeoneRet_4_152"/>
													<span>(可分配返点范围为0-9.9)</span>
												</td>
											</tr>
										</table>
									...
									<dd>
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">直选返点</a>
													<input type="input" class="input w-2" name="directRet_2_142"  value="0-9.9" maxvalue="9.9" onKeyUp="CheckingMaxAllFull(this,'9.9')" onBlur="CheckingMaxAllFull(this,'9.9')"/>
													<span>(可分配返点范围为0-9.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_2_142" value="0-1"/></td>
											</tr>
											<tr>
												<td>
													<a class="label-like" data-wanfa="blah">不定位返点</a>
													<input type="input" onKeyUp="CheckingMaxAllFull(this,'4.9')" onBlur="CheckingMaxAllFull(this,'4.9')" class="input w-2" maxvalue="4.9" value="0-4.9" name="threeoneRet_2_142"/>
													<span>(可分配返点范围为0-4.9)</span>
												</td>
											</tr>
										</table>
									...
									<dd class="bet-selected">
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">直选返点</a>
													<input type="input" class="input w-2" name="directRet_2_143"  value="0-19.9" maxvalue="19.9" onKeyUp="CheckingMaxAllFull(this,'19.9')" onBlur="CheckingMaxAllFull(this,'19.9')"/>
													<span>(可分配返点范围为0-19.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_2_143" value="0-1"/></td>
											</tr>
											<tr>
												<td>
													<a class="label-like" data-wanfa="blah">不定位返点</a>
													<input type="input" onKeyUp="CheckingMaxAllFull(this,'12.9')" onBlur="CheckingMaxAllFull(this,'12.9')" class="input w-2" maxvalue="12.9" value="0-12.9" name="threeoneRet_2_143"/>
													<span>(可分配返点范围为0-12.9)</span>
												</td>
											</tr>
										</table>
									...
									<dd class="bet-selected">
										<table class="table">
											<tr>
												...
												<td>
													<a class="label-like" data-wanfa="blah">所有玩法返点</a>
													<input type="input" class="input w-2" name="directRet_5_187"  value="0-4.9" maxvalue="4.9" onKeyUp="CheckingMaxAllFull(this,'4.9')" onBlur="CheckingMaxAllFull(this,'4.9')"/>
													<span>(可分配返点范围为0-4.9)</span>
												</td>
												<td rowspan="2"><input type="checkbox" class="checkbox" disabled checked name="status_5_187" value="0-1"/></td>
											</tr>
										</table>
									</dd>
								</dl>
						...
						$(function(){
							var markup = 
								...
								'</div>';
							var $wanfan = $('.wanfa-pop').fadeOut(0);
							if( !$wanfan.length ){
								$wanfan = $(markup).fadeOut(0).appendTo('body');
							}
							...
							$('.label-like[data-wanfa]').on('click', function(){
								...
								// 获取玩法的数据，如果有
								var wanfaData = $t.data('wanfaData');
								$wanfan.css({
								...
								if( wanfaData ){
									...
									$.get(ajaxurl, {wanfa: wanfa}, function(resp){
										resp = $.parseJSON(resp);
										if( resp.status == 'ok' ){
						...
						<div class="rebate-btn">
							<a href="javascript:void(0);" class="btn btn-important" id="J-btn-Subm">修改返点<b class="btn-inner"></b></a>
						</div>
					</div>
	...
	<!-- //////////////底侧公共页面////////////// -->
		<div class="footer">
	<div class="g_33">
		<span class="copy">&copy; 2001-2012 591PH. All right reserved. 凤凰游戏平台版权所有</span><a href="http://www2.joy188.com:888/help/goIndex">帮助中心</a> | <a href="javascript:hj5107.openChat()">在线客服</a> | <a href="javascript:void(0);">游戏介绍</a> | <a href="javascript:void(0);">下载客户端</a> | <a href="javascript:void(0);">翻墙工具</a>
	</div>
</div>	<!-- /////////////底侧公共页面/////////////// -->	
