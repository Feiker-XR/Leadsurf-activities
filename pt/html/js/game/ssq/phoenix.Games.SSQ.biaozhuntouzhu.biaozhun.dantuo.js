...
(function(host, GameMethod, undefined){
	...
	var pros = {
		...
		randomNum: function(){
			...
			//注单信息
			order = {
				'type':  'biaozhuntouzhu.biaozhun.fushi',
				'original': original,
				'lotterys': lotterys,
	...
	var html_head = [];
		...
		//  胆码区
	var html_row_dan = [];
		html_row_dan.push('<div class="dan-ball-section ball-section">');
		...
		//  拖码区
	var html_row_tuo = [];
		html_row_tuo.push('<div class="tuo-ball-section ball-section">');
		...
		//蓝球
	var html_row_blue = [];
			html_row_blue.push('<div class="tuodanblue-ball-section ball-section">');
