$(document).ready(function(){
	...
	//搜索输入框默认文本
	var Input = new phoenix.Input({defText:$('#J-hidden-word').val(),el:'#J-search-input'});
	...
	$('#J-table-list').on('click', '.word-rename', function(e){
		...
		Wd.show({
			...
			title:'修改敏感词',
			content:$('#J-tpl-modifykeyword').text(),
			callback:function(){
