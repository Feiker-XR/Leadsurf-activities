...
$(document).ready(function(){
	...
	dels.click(function(e){
		...
		strArr.push('<div class="control"><a id="sButton" data-buttontype="1" href="javascript:void(0);" class="btn">确定<b class="btn-inner"></b></a> <a data-buttontype="0" href="javascript:void(0);" class="btn">取消<b class="btn-inner"></b></a></div>');
