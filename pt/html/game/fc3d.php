...
<head>
	...
	<link rel="stylesheet" href="../images/game/fc3d/fc3d.css" />
<!-- 工具类 -->
...
<!-- 实例类 -->
<script type="text/javascript" src="../js/game/fc3d/phoenix.Games.FC3D.js"></script>
<script type="text/javascript" src="../js/game/fc3d/phoenix.Games.FC3D.Config.js" ></script>
<script type="text/javascript" src="../js/game/fc3d/phoenix.Games.FC3D.Message.js" ></script>
<!-- 单例类 -->
...
<!-- 额外的单式父类 -->
<script type="text/javascript" src="../js/game/fc3D/phoenix.Games.FC3D.Danshi.js" ></script>
...
(function(){
	...
	var Games = phoenix.Games;
		...
		Games.getCurrentGameTypes().addEvent('endShow', function() {
			this.changeMode('sanxing.zhixuan.fushi');
		});
