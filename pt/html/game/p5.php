...
<head>
	...
	<link rel="stylesheet" href="../images/game/p5/p5.css" />
<!-- 工具类 -->
...
<!-- toolbar start -->
	...
	<div class="header">
		<div class="g_33">
			...
			<div class="deadline">
				<div class="deadline-text">第<strong id="">2013110</strong>期<br />离投注截止还有</div>
			...
			<div class="lottery">
				<div class="lottery-text">第<strong id="">2013110</strong>期<br /><a href="#" target="_blank">开奖号码&gt;</a></div>
...
<!-- 实例类 -->
<script type="text/javascript" src="../js/game/P5/phoenix.Games.P5.js" ></script>
<script type="text/javascript" src="../js/game/P5/phoenix.Games.P5.Config.js" ></script>
<script type="text/javascript" src="../js/game/P5/phoenix.Games.P5.Message.js" ></script>
<!-- 单例类 -->
...
<script type="text/javascript" src="../js/game/P5/phoenix.Games.p5.GameTypes.js" ></script>
<script type="text/javascript" src="../js/game/phoenix.GameSubmit.js" ></script>
<!-- 额外的单式父类 -->
<script type="text/javascript" src="../js/game/P5/phoenix.Games.P5.Danshi.js" ></script>
...
(function(){
	...
	var Games = phoenix.Games;
		...
		Games.getCurrentGameTypes().addEvent('endShow', function() {
			this.changeMode('p5houer.zhixuan.zhixuanp5houerfushi');
		});
