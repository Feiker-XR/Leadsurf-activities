...
<script type="text/javascript">global_path_pagename = "game-ssc";</script>
...
<!-- 公告通知
<script type="text/javascript" src="../js/phoenix.Notice.js" ></script>
 -->
...
<!-- toolbar start -->
	...
	<div class="header">
		<div class="g_33">
			...
			<div class="deadline">
				<div class="deadline-text">第<strong id="">20130320-012</strong>期<br />离投注截止还有</div>
				<div class="deadline-number">
					<strong>预售中</strong>
				</div>
			</div>
			<div class="lottery">
				<div class="lottery-text">第<strong id="">20130320-012</strong>期<br /><a href="#" target="_blank">开奖号码&gt;</a></div>
	...
	<div class="g_33 main">
		...
		<div class="play-section">
			<div class="program-chase">
				...
				<div class="program-chase-none" style="display:none;">你最近7天暂时没有投注记录</div>
...
<!-- 实例类 -->
<script type="text/javascript" src="../js/game/ssc/phoenix.Games.SSC.js" ></script>
<script type="text/javascript" src="../js/game/ssc/phoenix.Games.SSC.Config.php" ></script>
<script type="text/javascript" src="../js/game/ssc/phoenix.Games.SSC.Message.js" ></script>
<!-- 单例类 -->
...
<!-- 额外的单式父类 -->
<script type="text/javascript" src="../js/game/ssc/phoenix.Games.SSC.Danshi.js" ></script>
...
var init = function(config){
	...
	var Games = phoenix.Games;
		...
		// 此段为测试
		Games.getCurrentGame().lotteryBallsAnimation('#J-lottery-info-balls', [1,2,3,4,5]);
		...
		Games.getCurrentGame().addEvent('changeDynamicConfig', function(e, cfg){
			...
			Games.getCurrentGame().lotteryBallsAnimation('#J-lottery-info-balls', lastballs);
