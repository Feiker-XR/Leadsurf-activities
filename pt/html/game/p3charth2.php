...
<!-- toolbar start -->
	...
	<div class="select-section clearfix">
		...
		<ul class="select-list">
			...
			<li class="current"><a href="p3charth2.php">P3后二</a></li>
		</ul>
	</div>
...
var CHART;
(function($){
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../js/json/p3h2.php', currentGameMethod: 'Houer', expands:{
