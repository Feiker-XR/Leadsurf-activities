...
<!-- toolbar start -->
	...
	<div class="select-section clearfix">
		...
		<ul class="select-list">
			...
			<li class="current"><a href="p3chart.php">P3基本</a></li>
		...
		<table class="chart-table" id="J-chart-table">
			...
			<tbody id="J-select-content" class="tbody">
				<tr id="J-tr-select" class="select-area">
					...
					<td colspan="3" class="border-right border-bottom">前三</td>
...
(function($){
	...
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../js/json/p3.php', currentGameMethod: 'Qiansan', expands:{
