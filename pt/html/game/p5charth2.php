...
<!-- toolbar start -->
	...
	<div class="select-section clearfix">
		...
		<ul class="select-list">
			...
			<li class="current"><a href="p5charth2.php">P5后二</a></li>
			<li><a href="p3chart.php">P3基本</a></li>
			<li><a href="p3chartq2.php">P3前二</a></li>
		...
		<table class="chart-table" id="J-chart-table">
			...
			<tbody id="J-select-content" class="tbody">
				<tr id="J-tr-select" class="select-area">
					...
					<td colspan="3" class="border-right border-bottom">后二</td>
...
var CHART;
(function($){
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../js/json/p5h2.php', currentGameMethod: 'Houer', expands:{
