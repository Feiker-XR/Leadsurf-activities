...
<tr class="title-number">
			...
			<tbody id="J-select-content" class="tbody">
				<tr id="J-tr-select" class="select-area">
					...
					<td colspan="3" class="border-right border-bottom">后三</td>
...
var CHART;
(function($){
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../js/json/ssc_housan.php', currentGameMethod: 'Housan', expands:{
