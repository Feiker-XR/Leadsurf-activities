...
<head>
	...
	<link rel="stylesheet" href="../images/game/lln115/lln115.css" />
<!-- 工具类 -->
	...
	<div class="header">
		<div class="g_33">
			...
			<div class="deadline">
				...
				<div class="deadline-text">第<strong id="">20130320-012</strong>期</div>
			</div>
			<div class="lottery">
				...
				<div class="lottery-text">第<strong id="">20130320-012</strong>期<a href="#" target="_blank">开奖号码</a></div>
			</div>
			<div class="video-link">
				<div class="lottery-video">美女互动开奖视频</div>
...
<!-- 提交按钮开始 -->
		<div class="bet-btn"><input type="button" id="J-submit-order" value="马上投注"></div>
<!-- 提交按钮结束 -->
...
<!-- 实例类 -->
<script type="text/javascript" src="../js/game/LLN115/phoenix.Games.LLN115.js" ></script>
<script type="text/javascript" src="../js/game/LLN115/phoenix.Games.LLN115.Config.js" ></script>
<script type="text/javascript" src="../js/game/LLN115/phoenix.Games.LLN115.Message.js" ></script>
<script type="text/javascript" src="../js/game/LLN115/phoenix.Games.LLN115.Video.js" ></script>
<!-- 单例类 -->
...
<!-- 额外的单式父类 -->
<script type="text/javascript" src="../js/game/LLN115/phoenix.Games.LLN115.Danshi.js" ></script>
...
(function(){
	...
	var Games = phoenix.Games;
		...
		Games.getCurrentGameTypes().addEvent('endShow', function() {
			this.changeMode('xuanyi.renxuanyizhongyi.fushi');
		});
...
<!-- 
<script type="text/javascript" src="http://127.0.0.1/html/js/game/N115/phoenix.Games.N115.xuanyi.renxuanyizhongyi.danshi.js?_=1380856511812" ></script>
