		...
		<table class="chart-table" id="J-chart-table">
			...
			<tbody id="J-select-content" class="tbody">
				<tr id="J-tr-select" class="select-area">
					...
					<td colspan="3" class="border-right">四星</td>
...
var CHART;
(function($){
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../js/json/ssc_sixing.php', currentGameMethod: 'Sixing', expands:{
