...
(function($){
	...
	CHART = new phoenix.GameCharts({currentGameType:'n115', getDataUrl: '../../js/json/n115_qianer.php', currentGameMethod: 'Qianer', expands:{
		n115QianerRender:function(data, currentNum){
			var td,
				current,
				me = this,
		...
		n115QianerRenderStatistics: function(data){
			var me = this,
				index = 0,
				i = 0,
				len = 0,
		...
		n115QianerTrendCanvas:function(dom, data){
			var positionCount = 0,
				me = this,
				currentBallLeft = 0,
				currentBallTop = 0,
				...
				for (var k = 0; k < current.length; k++) {
					...
					if (k > 1 && k < 4) {
						for (var j = 0; j < current[k].length; j++) {
							...
							currentDom = dom.getElementsByTagName('i')[positionCount].parentNode,
							unitSize = me.getUnitSize(currentDom),
							width = unitSize.widthNum,
							height = unitSize.heightNum;
