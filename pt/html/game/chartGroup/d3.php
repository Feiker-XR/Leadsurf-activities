...
<!-- toolbar start -->
	...
	<div class="select-section clearfix">
		...
		<h3 class="select-title">彩种：3D</h3>
		<ul class="select-list">
			<li class="current"><a href="d3.php">3D</a></li>
		</ul>
	</div>
...
(function($){
	...
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../../js/json/d3.php', currentGameMethod: 'Qiansan', expands:{
