...
<!-- toolbar start -->
	...
	<div class="select-section clearfix">
		...
		<ul class="select-list">
			<li class="current"><a href="kl8_ball.php">开奖号码走势图</a></li>
			<li><a href="kl8.php">综合走势图</a></li>
		</ul>
	</div>
	<div class="select-section-content clearfix" id="J-panel-control">
		<div class="title">开奖号码走势图</div>
		<div class="function">
		...
		<table class="chart-table" id="J-chart-table">
			<thead class="thead">
				<tr class="title-text">
					...
					<th colspan="82" class="border-right border-bottom">号码分布</th>
				</tr>
				<tr class="title-text">
...
(function($){
	...
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../../js/json/kl8_ball.json', currentGameMethod: 'Qiansan', expands:{
		cqsscQiansanRender:function(data, currentNum){
			...
			// 奖球区
			parentDom.appendChild(me.singleLotteryBall(data["balls"], styleName));
		...
		cqsscQiansanRenderStatistics: function(data){
			...
			var statics_len = 80;
			for(i = 0, len = statics_len; i < len; i++){
				tdstr = ((i+1)%statics_len == 0) ? '<td class="ball-none border-right border-bottom"></td><td class="ball-none border-bottom"></td>' : '';	
