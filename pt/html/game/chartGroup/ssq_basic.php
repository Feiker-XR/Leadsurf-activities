...
<!-- toolbar start -->
	...
	<div class="select-section clearfix">
		...
		<ul class="select-list">
			<li class="current"><a href="ssq_basic.php">基本走势图</a></li>
...
(function($){
	...
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../../js/json/ssq_basic.json', currentGameMethod: 'Qiansan', expands:{
		cqsscQiansanRender:function(data, currentNum){
			...
			// 蓝球区一
			parentDom.appendChild(me.singleLotteryBall(data["blueZone1"], styleName, true));
			// 蓝球区二
			parentDom.appendChild(me.singleLotteryBall(data["blueZone2"], styleName, true));
