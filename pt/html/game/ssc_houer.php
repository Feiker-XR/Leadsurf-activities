				...
				<tr>
					...
					<td colspan="24" class="border-bottom border-right">
						<form id="J-form-submit" method="get" action="http://test.com/html/game/ssc.php" target="_blank">
							<input type="hidden" name="gametype" value="houer" />
...
var CHART;
(function($){
	CHART = new phoenix.GameCharts({currentGameType:'cqssc', getDataUrl: '../js/json/ssc_houer.php', currentGameMethod: 'Houer', expands:{
