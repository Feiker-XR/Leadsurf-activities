...
<head>
	...
	<link rel="stylesheet" href="../images/game/bjkl8/bjkl8.css" />
<!-- 工具类 -->
...
<!-- toolbar start -->
	...
	<div class="header">
		<div class="g_33">
			<h1 class="logo"><a title="北京快乐8" href="#">北京快乐8</a></h1>
			<div class="deadline">
				<div class="deadline-text">第<strong id="">578192</strong>期<br />离投注截止还有</div>
			...
			<div class="lottery">
				<div class="lottery-text">第<strong id="">578192</strong>期<br /><a href="#" target="_blank">开奖号码&gt;</a></div>
				...
				<div class="lottery-info">和值=854(大,单)<br />盘面=下,奇</div>
	...
	<div class="g_33 main">
		...
		<div class="public-notice"><i class="ico-close"></i><div><i class="ico-volume"></i>尊敬的客户您好，娱乐平台提醒您，重启时时彩2月16日</div></div>
		<div class="play-section">
					...
					<li>
						<table class="program-chase-table">
							...
							<tbody>
								...
								<tr>
									<td colspan="4" class="text-right"><a href="#"target="_blank" class="more">更多&raquo;</a></td>
								</tr>
							</tbody>
						</table>
					</li>
			...
			<div id="J-play-select" class="play-select">
				<div class="prompt">
					...
					<span class="">玩法提示：从01-80中选择7个号码组成一注，当期开奖结果的20个号码中包含7个、6个、5个或4个所选号码，或者出现0个所选号码，即可中奖。不可兼中兼得。</span>
...
<!-- 实例类 -->
<script type="text/javascript" src="../js/game/bjkl8/phoenix.Games.BJKL8.js" ></script>
<script type="text/javascript" src="../js/game/bjkl8/phoenix.Games.BJKL8.Config.js" ></script>
<script type="text/javascript" src="../js/game/bjkl8/phoenix.Games.BJKL8.Message.js" ></script>
<!-- 单例类 -->
...
<!-- 额外的单式父类 -->
<script type="text/javascript" src="../js/game/bjkl8/phoenix.Games.BJKL8.Renxuan.js" ></script>
<script type="text/javascript" src="../js/game/bjkl8/phoenix.Games.BJKL8.Charts.js" ></script>
...
var init = function(config){
	...
	var Games = phoenix.Games;
		...
		Games.getCurrentGameTypes().addEvent('endShow', function() {
			this.changeMode('quwei.panmian.quweib');
		});
		//任选玩法隐藏走势图按钮
