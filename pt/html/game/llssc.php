...
<head>
	...
	<link rel="stylesheet" href="../images/game/llssc/llssc.css" />
...
<script type="text/javascript" src="../js/game/util/swfobject.js" ></script>
<!-- 公告通知 -->
...
<!-- toolbar start -->
	...
	<div class="header">
		<div class="g_33">
			...
			<div class="deadline">
				<div class="deadline-text"><strong id="">20130320</strong><br />第<strong id="">022</strong>期<br />截止时间</div>
			...
			<div class="lottery">
				<div class="lottery-text"><strong id="">20130320</strong><br />第<strong id="">022</strong>期<br />开奖号码</div>
				...
				<div class="lottery-link">
					<a class="chart" target="_blank" href="#">号码走势</a>
					<a class="info" target="_blank" href="#">游戏说明</a>
				</div>
			</div>
			<div class="deadline-video"></div>
		</div>
	</div>
	<!-- 开奖视频开始 -->
		...
		<div class="number-section">
			...
			<div id="J-balls-statistics-panel">
				<ul class="bet-statistics">
					...
					<li class="total-money">共<strong class="price" id=""> <dfn>&yen;</dfn>300.00 </strong>元</li>
				</ul>
				...
				<div class="chase-tab">
					<div class="chase-tab-title clearfix">
						...
						<div id="J-trace-iswinstop-panel" class="chase-stop" style="display:none;">
							...
							<i class="icon-question" id="J-trace-iswinstop-hover">玩法提示</i>
						...
						<div id="J-trace-iswintimesstop-panel" class="chase-stop">
							...
							<i class="icon-question" id="J-trace-iswintimesstop-hover">玩法提示</i><div id="chase-stop-tip-1" class="chase-stop-tip">
...
<!-- 实例类 -->
<script type="text/javascript" src="../js/game/llssc/phoenix.Games.LLSSC.js" ></script>
<script type="text/javascript" src="../js/game/llssc/phoenix.Games.LLSSC.Config.js" ></script>
<script type="text/javascript" src="../js/game/llssc/phoenix.Games.LLSSC.Message.js" ></script>
<script type="text/javascript" src="../js/game/llssc/phoenix.Games.LLSSC.Video.js" ></script>
<!-- 单例类 -->
...
<!-- 额外的单式父类 -->
<script type="text/javascript" src="../js/game/llssc/phoenix.Games.LLSSC.Danshi.js" ></script>
